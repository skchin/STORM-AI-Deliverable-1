...
%%----------------------------
%% Ragged right justification to match NSA CTR template
%%----------------------------
\usepackage{ragged2e}
...
%%%-----------------------------
%% adjust spacing between section titles
%% \titlespacing*{\section}{left}{before-sep}{after-sep}
%% left: Horizontal space to left (usually 0pt)
%% before-sep: vertical space before the title
%% after-sep: vertical space after the title
%%-----------------------------
...
%Secure, and Trustworthy AI}}%
                 {16}\selectfont\textbf{NSA | A Critical Analysis of Reliable, Secure, and Trustworthy AI}}%
           };
        \end{tikzpicture}%
    }
...
%Secure, and Trustworthy AI}}%
{30}\selectfont\textbf{A Critical Analysis of Reliable, Secure, and Trustworthy AI}}%
    };
...
Not applicable.
%Technology is a registered trademark of company. Technology is a registered trademark of company.
...
%\input{execSummaryAlt}
\input{execSummary-jcoh}
\clearpage
...
\input{combined345}
\input{Graphical view of the Results}
\input{Gaps and Recommendations}
