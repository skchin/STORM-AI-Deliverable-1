...
\begin{figure}[h]
    \centering
    \includegraphics[width=1.0\linewidth]{Figures/Paper-Classification-Results.jpg}
    \caption{\it Results of searching and classifying 54,628 AI papers: fewer than 17\% address AI Trustworthiness, Reliability, or Security; few or none of those address organizational or mission requirements. \textbf{Mission Assurance is completely neglected.}}
    \label{fig:heatmapAlt}
\end{figure}

\section{Mission Assurance is Completely Neglected by AI Research}
